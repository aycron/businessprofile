...
module FckeditorFileUtils
  FCKEDITOR_INSTALL_DIRECTORY = File.join(RAILS_ROOT, '/public/javascripts/aycron_cms_core/fckeditor/')
  ...
  def FckeditorFileUtils.backup_existing
    source = File.join(RAILS_ROOT,'/public/javascripts/aycron_cms_core/fckeditor')
    dest = File.join(RAILS_ROOT,'/public/javascripts/aycron_cms_core/fckeditor_bck')
  ...
  def FckeditorFileUtils.copy_configuration
    ...
    config_file = File.join(RAILS_ROOT, '/vendor/plugins/aycron_cms_core/public/javascripts/aycron_cms_core/fckcustom.js')
    dest = File.join(RAILS_ROOT, '/public/javascripts/aycron_cms_core/fckcustom.js')
  ...
  def FckeditorFileUtils.install(log) 
    ...
    source = File.join(directory,'/public/javascripts/aycron_cms_core/fckeditor/')
