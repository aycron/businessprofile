...
module Fckeditor
  ...
  module Helper
    def fckeditor_textarea(object, field, options = {})
      ...
      bodyClass = options[:bodyClass].nil? ? '' : options[:bodyClass]
      ...
      js_path = "#{ActionController::Base.relative_url_root}/javascripts/aycron_cms_core"
...
module ActionView::Helpers::AssetTagHelper
  ...
  def javascript_include_tag(*sources)
    ...
    if sources.include?(:fckeditor)
      ...
      sources.push('aycron_cms_core/fckeditor/fckeditor')
    end
