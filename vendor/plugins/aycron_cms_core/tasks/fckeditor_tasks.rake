...
namespace :fckeditor do
  ...
  task :download do
    ...
    puts "** Shifting files to /public/javascripts/aycron_cms_core/fckeditor"
    FileUtils.cp_r File.join(RAILS_ROOT, "/tmp/fckeditor/"), File.join(RAILS_ROOT, "/public/javascripts/aycron_cms_core/")
